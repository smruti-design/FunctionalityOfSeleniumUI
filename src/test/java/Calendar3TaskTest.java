...
public class Calendar3TaskTest {

    static WebDriver driver;

    @Test
    public void extractHolidayAndWeekendsCalendar() throws InterruptedException {
    ...
    public static void viewHolidayAndWeekends(String data) {
        ...
        String dateText = driver.findElement(By.cssSelector("div[class='DayNavigator__CalendarHeader-qj8jdz-1 fxvMrr'] div:nth-child(2)")).getText();
        ...
        while(!(currentYear.equals(expectedYear) && currentMonth.equals(expectedMonth))){
            ...
            driver.findElement(By.cssSelector("div[class='DayNavigator__CalendarHeader-qj8jdz-1 fxvMrr']>div:nth-last-child(1)")).click();
            dateText = driver.findElement(By.cssSelector("div[class='DayNavigator__CalendarHeader-qj8jdz-1 fxvMrr'] div:nth-child(2)")).getText();
            s = dateText.split("\n");
            d = s[0].split(" ");
            currentMonth = d[0];
            currentYear = d[1];
